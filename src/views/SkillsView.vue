<template>
    <div id="skills" class="container text-start h-100 my-5 p-5 justify-content-between overflow-auto">
            ...
            <div class="col-md-3">
                <div class="text-black" data-aos="zoom-out-down">
                    ...
                    <ul>
                        ...
                        <li>Numeracy and Analytical skills</li>
                        ...
                        <div class="col-md-6">
                            ...
                            <ul class="list-unstyled text-black">
                                <li>
                                    ...
                                    <div class="progress ">
                                        <div class="progress-bar bg-black" role="progressbar" style="width: 85%"
                                ...
                                <li>
                                    ...
                                    <div class="progress ">
                                        <div class="progress-bar bg-black" role="progressbar" style="width: 75%"
                        ...
                        <div class="col-md-6">
                            <ul class="list-unstyled text-black">
                                <li>
                                    ...
                                    <div class="progress ">
                                        <div class="progress-bar bg-black" role="progressbar" style="width: 95%"
                                ...
                                <li>
                                    ...
                                    <div class="progress">
                                        <div class="progress-bar bg-black" role="progressbar" style="width: 35%"
