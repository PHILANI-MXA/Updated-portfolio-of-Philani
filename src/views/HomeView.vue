<template>
  ...
  <!-- <div
    id="home"
    class="container vh-100 overflow-hidden d-flex m-auto d-flex justify-content-center align-items-center"
  >
    <div class="row">
      <div class="col-md-2">
        <hr />
...
.text-container h2
{
	...
	opacity: 0;
	user-select: none;
	background: linear-gradient(45deg,#fff200,#d400ff, #0ff);
