<template>
    <div id="experience" class="p-5 my-5 container text-start vh-100 justify-content-between">
        <h2 class="text-center bg-black p-3 fw-bolder p-3">Work Experience</h2>
        <div class="row p-3">
            <div class="col-md-4">
                <div class="">
                    <div class="avatar">
